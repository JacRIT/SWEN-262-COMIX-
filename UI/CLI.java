...
// /**
// * Take the input from the user and map the command to the correct
// functionality
// *
...
// this.log("Flags must contain a name and value ie; \"--<name>=<value>",
// false);
// this.log(flag);
// return false;
// }
...
// this.log("Enter a command below then press enter to continue to the next
// steps.");
...
// \"publication\", \"issue\", \"volume\"", false);
// this.log(
// "\t[--searchBy=<value>] - search comics by\n\t\t\"partial-search\",
// \"exact-search\", \"exact-number\", \"value\"");
...
// if (searchType.equals("partial-search") || searchType.length() == 0 ||
// searchType == null) {
